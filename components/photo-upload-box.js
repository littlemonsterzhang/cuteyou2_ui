...
export default function PhotoUploadBox() {
  ...
  const handleUpload = async () => {
    ...
    try {
      // Replace this URL with your actual server endpoint for saving images
      ...
      if (!response.ok) {
        ...
        throw new Error(`Save failed: ${response.status} ${response.statusText}. Server response: ${errorData}`)
      }
